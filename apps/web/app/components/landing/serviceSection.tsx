                ...
                {services.map((service, index) => (
                    <Card key={index} className="hover:shadow-lg transition-shadow group">
                        <CardContent className="p-6 text-center">
                            ...
                            <Button size="sm" style={{backgroundColor: "#FF8C42", backgroundImage: "linear-gradient(276.68deg, #FFB347 20.18%, #FF6B35 94.81%)"}} className="text-white font-bold hover:opacity-90 cursor-pointer">BOOK NOW</Button>
                        </CardContent>
                    </Card> 
                ))}
            </div>
